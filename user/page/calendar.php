                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item">
                                    <a href="navbar.php"><i class="ik ik-menu"></i><span>Navigation</span> <span class="badge badge-success">New</span></a>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Widgets</span> <span class="badge badge-danger">150+</span></a>
                                    <div class="submenu-content">
                                        <a href="widgets.php" class="menu-item">Basic</a>
                                        <a href="widget-statistic.php" class="menu-item">Statistic</a>
                                        <a href="widget-data.php" class="menu-item">Data</a>
                                        <a href="widget-chart.php" class="menu-item">Chart Widget</a>
                                    </div>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="ui/alerts.php" class="menu-item">Alerts</a>
                                        <a href="ui/badges.php" class="menu-item">Badges</a>
                                        <a href="ui/buttons.php" class="menu-item">Buttons</a>
                                        <a href="ui/navigation.php" class="menu-item">Navigation</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-gitlab"></i><span>Advance</span> <span class="badge badge-success">New</span></a>
                                    <div class="submenu-content">
                                        <a href="ui/modals.php" class="menu-item">Modals</a>
                                        <a href="ui/notifications.php" class="menu-item">Notifications</a>
                                        <a href="ui/carousel.php" class="menu-item">Slider</a>
                                        <a href="ui/range-slider.php" class="menu-item">Range Slider</a>
                                        <a href="ui/rating.php" class="menu-item">Rating</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-package"></i><span>Extra</span></a>
                                    <div class="submenu-content">
                                        <a href="ui/session-timeout.php" class="menu-item">Session Timeout</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="ui/icons.php"><i class="ik ik-command"></i><span>Icons</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="form-addon.php" class="menu-item">Add-On</a>
                                        <a href="form-advance.php" class="menu-item">Advance</a>
                                    </div>
                                </div>
                                <div class="nav-item">
                                    <a href="form-picker.php"><i class="ik ik-terminal"></i><span>Form Picker</span> <span class="badge badge-success">New</span></a>
                                </div>

                                <div class="nav-lavel">Tables</div>
                                <div class="nav-item">
                                    <a href="table-bootstrap.php"><i class="ik ik-credit-card"></i><span>Bootstrap Table</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="table-datatable.php"><i class="ik ik-inbox"></i><span>Data Table</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        <a href="charts-chartist.php" class="menu-item">Chartist</a>
                                        <a href="charts-flot.php" class="menu-item">Flot</a>
                                        <a href="charts-knob.php" class="menu-item">Knob</a>
                                        <a href="charts-amcharts.php" class="menu-item">Amcharts</a>
                                    </div>
                                </div>

                                <div class="nav-lavel">Apps</div>
                                <div class="nav-item active">
                                    <a href="calendar.php"><i class="ik ik-calendar"></i><span>Calendar</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="taskboard.php"><i class="ik ik-server"></i><span>Taskboard</span></a>
                                </div>
                                ...
                                <div class="nav-item has-sub">
                                    ...
                                    <div class="submenu-content">
                                        ...
                                        <a href="forgot-password.php" class="menu-item">Forgot Password</a>
                                    </div>
                                </div>
                                <div class="nav-item has-sub">
                                ...
                                <div class="nav-item">
                                    <a href="layouts.php"><i class="ik ik-layout"></i><span>Layouts</span><span class="badge badge-success">New</span></a>
                                </div>
