            ...
            <div class="container-fluid h-100">
                <div class="row flex-row h-100 bg-white">
                    <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                        <div class="lavalite-bg" style="background-image: url('img/anppcan2.png'); width:73%; margin-left:60px;">
                            <div class="lavalite-overlay" style="width: 0%;"></div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto" style="width: 80%;">
                            <div class="logo-centered">
                                <a href="#"><img src="img/anppcan2.png" alt="" width="100%"></a>
                            </div>
